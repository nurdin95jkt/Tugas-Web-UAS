...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | Aplikasi Persediaan Obat Apotek Sehat Selalu</title>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="assets/img/lambang.jpg" />
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <footer class="main-footer">
        <strong><i>Copyright &copy; 2020 - Apotek Sehat Selalu</i></a></strong>
      </footer>
    </div><!-- ./wrapper -->
